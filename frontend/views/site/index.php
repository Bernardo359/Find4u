...
$this->title = 'Find4U - Home';

?>
<div class="main-banner">
  <div class="owl-carousel owl-banner">
    <div class="item item-1" style="background-image: url('../../web/img/HomeBanner.jpg');">
    ...
    <div class="item item-2" style="background-image: url('../../web/img/HomeBanner2.jpg');">
      <div class="header-text">
    ...
    <div class="item item-3" style="background-image: url('../../web/img/HomeBanner3.jpg');">
      <div class="header-text">
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="left-image">
            <img src="../../web/img/featured.jpg" alt="">
            <a href="property-details.html"><img src="../../web/img/featured-icon.png" alt="" style="max-width: 60px; padding: 0px;"></a>
          </div>
        </div>
        <div class="col-lg-5">
